...
func ProcessMetrics(metricFamilies []*io_prometheus_client.MetricFamily, target, prober, jobName string, label, tags map[string]interface{}) ([]prompb.TimeSeries, error) {
